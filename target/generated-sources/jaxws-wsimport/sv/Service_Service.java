 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://sv/", wsdlLocation = "http://localhost:8080/ProyectoSoap_V1/Service?WSDL")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://sv/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ProyectoSoap_V1/Service?WSDL");
    ...
    public sv.Service getServicePort() {
        return super.getPort(new QName("http://sv/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public sv.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sv/", "ServicePort"), Service.class, features);
    }

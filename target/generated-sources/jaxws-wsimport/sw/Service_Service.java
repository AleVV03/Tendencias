 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://sw/", wsdlLocation = "http://localhost:8080/ProyectoWedService_V1/Service?WSDL")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://sw/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ProyectoWedService_V1/Service?WSDL");
    ...
    public sw.Service getServicePort() {
        return super.getPort(new QName("http://sw/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public sw.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sw/", "ServicePort"), Service.class, features);
    }
